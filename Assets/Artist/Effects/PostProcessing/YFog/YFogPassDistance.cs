...
public class YFogPassDistance : ScriptableRenderPass
{
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        YFogVolmeDistance fogVolme = VolumeManager.instance.stack.GetComponent<YFogVolmeDistance>();
