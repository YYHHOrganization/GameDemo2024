...
namespace Core.AI
{
    public class YEnemyAirDashNonPhysical  : YBTEnemyAction
    {
        ...
        private void StartDash()
        {
            ...
            if(player == null)
            {
                ...
                else
                {
                    ...
                    dashUpTween=transform.DOMove(player.transform.position, dashTime).SetEase(Ease.OutQuad);
