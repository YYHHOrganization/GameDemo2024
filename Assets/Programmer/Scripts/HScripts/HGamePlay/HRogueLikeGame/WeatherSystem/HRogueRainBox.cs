...
public class HRogueRainBox : MonoBehaviour
{
    private MeshFilter mf ;	
	private Vector3 defaultPosition;
	private Bounds bounds;

	private HRogueRainManager manager;
    ...
    void Start()
    {
        manager = transform.parent.GetComponent<HRogueRainManager>();
    ...
    void OnDrawGizmos()
    {
        ...
        if (transform.parent)
        {
            ...
            HRogueRainManager manager = transform.parent.GetComponent<HRogueRainManager>();
            if (manager)
