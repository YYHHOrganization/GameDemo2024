...
public class YRogueEnemyFlyState  : HRogueEnemyBaseState
{
    ...
    public YRogueEnemyFlyState(HRogueEnemyPatrolAI patrolAI) : base(patrolAI.gameObject)
    {
        mPatrolAI = patrolAI;
    ...
    public override Type Tick()
    {
        ...
        if (mPatrolAI.mTarget && mPatrolAI.CheckIfTargetIsNear(mPatrolAI.enemy._RogueWanderPlayerSensitivePlayerDis()) || goToChase)
        {
            ...
            return typeof(YRogueEnemyThrowState);
        }
