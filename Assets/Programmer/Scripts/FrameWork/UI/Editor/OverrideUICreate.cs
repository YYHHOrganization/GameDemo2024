...
namespace OurGameFramework
{
    ...
    * "UI/Skin/UISprite.psd"
    ...
    "UI/Skin/UIMask.psd"
    */
    //todo:这里有很多还没有实现，后面再做补充
    public class OverrideUICreate
    {
        [MenuItem("GameObject/OurUISystem/Image", true)]
        public static void IgnoreImage()
        {
        }

        [MenuItem("GameObject/OurUISystem/Image.")]
        ...
        [MenuItem("GameObject/OurUISystem/Raw Image", true)]
        public static void IgnoreRawImage()
        {
        }

        [MenuItem("GameObject/OurUISystem/RawImage")]
        ...
        [MenuItem("GameObject/OurUISystem/Button")]
        ...
        [MenuItem("GameObject/OurUISystem/Text - TextMeshPro", true)]
        public static void IgnoreTextMeshPro()
        {
        }

        [MenuItem("GameObject/OurUISystem/Text -  TextMeshPro")]
        ...
        [MenuItem("GameObject/OurUISystem/Button - TextMeshPro", true)]
        public static void IgnoreButtonTextMeshPro()
        {
        }

        [MenuItem("GameObject/OurUISystem/Button -  TextMeshPro")]
        ...
        //#region ScrollRect
        [MenuItem("GameObject/OurUISystem/Scroll View", true)]
        ...
        [MenuItem("GameObject/OurUISystem/Slider", true)]
        public static void IgnoreSlider()
        {
        }

        [MenuItem("GameObject/OurUISystem/Slider.")]
